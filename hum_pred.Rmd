...
# cowplot::save_plot("figs/fig2_eulers.png", fig2_com, base_height = 10, base_width = 12, dpi = 600)
...
rang_vol <- data.frame(obs_rnd = rep(c("obs_vol", "rnd_vol"), 2), 
                       vol = c(mean(rn_used$obs_vol), median(rn_used$rnd_vol), median(rn_thrt$obs_vol), mean(rn_thrt$rnd_vol)), 
...
lin_vol <- data.frame(yintercept = c(mean(rn_used$rnd_vol), mean(rn_thrt$rnd_vol)), grp = factor(c("Used", "Extinction risk & use\nconsidered threat"), levels = c("Used", "Extinction risk & use\nconsidered threat")))
...
hyp_pred <- readRDS("data/processed/hyp_pred.rds")
...
hyp_hum <- readRDS("data/processed/hyp_hum.rds")
...
# cowplot::save_plot("figs/fig4_traits.png", fig4_cmp, base_width = 12, base_height = 12, dpi = 600)
...
# cowplot::save_plot("figs/fig_ED1_traits_eff.png", tri_plot_comb, base_height = 6, base_width = 12)
